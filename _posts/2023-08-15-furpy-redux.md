...
Then started sourcing components. Making sure to pick surface mount where possible. I decided to just through hole add-on for the IMU because it added a lot of complexity to the schematic. 
