...
The dashboard is running right now at `http://[local-server-ip]:7700` on my local network. Plex is working with hardware transcoding. The aria2 download manager is ready to pull ZIM files on demand. Ollama is up and waiting for a model pull.
